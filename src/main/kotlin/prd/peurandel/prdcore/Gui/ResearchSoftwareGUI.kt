...
class ResearchSoftwareGUI(plugin: JavaPlugin, private var database: MongoDatabase) : BaseGUI(plugin,"Research Software",54) {
    ...
    override fun initializeItems(plugin: JavaPlugin, player: String) {
        ...
        inventory.setItem(4, Button().SoftWare(plugin))
